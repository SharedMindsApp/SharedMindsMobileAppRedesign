...
create or replace function public.move_grocery_item_to_pantry(
  ...
  p_item_detail text default null,
  p_notes text default null,
  p_pantry_cost numeric default null,
  p_estimated_weight_grams numeric default null,
...
begin
  ...
  v_item_detail := coalesce(nullif(btrim(p_item_detail), ''), nullif(btrim(v_grocery_item.item_detail), ''));
  ...
  values (
    ...
    v_notes,
    p_pantry_cost,
    coalesce(p_estimated_weight_grams, v_grocery_item.estimated_weight_grams),
    v_added_by,
    p_total_portions,
