/**
 * Household Guide Card Component
 * 
 * Phase 9: UI component for displaying a Household guide section.
 */

import { HouseholdGuideSection } from './householdGuideContent';

interface HouseholdGuideCardProps {
  section: HouseholdGuideSection;
  variant?: 'mobile' | 'web';
}

export function HouseholdGuideCard({ section, variant = 'web' }: HouseholdGuideCardProps) {
  if (variant === 'mobile') {
    return (
