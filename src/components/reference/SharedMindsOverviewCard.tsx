/**
 * SharedMinds Overview Card Component
 * 
 * Phase 9: UI component for displaying a SharedMinds overview section with visual connections.
 */

import { SharedMindsOverviewSection } from './sharedMindsOverviewContent';
import { ArrowRight } from 'lucide-react';

interface SharedMindsOverviewCardProps {
  section: SharedMindsOverviewSection;
  variant?: 'mobile' | 'web';
}

export function SharedMindsOverviewCard({ section, variant = 'web' }: SharedMindsOverviewCardProps) {
  if (variant === 'mobile') {
    return (
