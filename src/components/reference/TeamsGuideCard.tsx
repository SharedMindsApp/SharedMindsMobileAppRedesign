/**
 * Teams Guide Card Component
 * 
 * Phase 9: UI component for displaying a Teams guide section.
 */

import { TeamsGuideSection } from './teamsGuideContent';
import { ArrowRight } from 'lucide-react';

interface TeamsGuideCardProps {
  section: TeamsGuideSection;
  variant?: 'mobile' | 'web';
}

export function TeamsGuideCard({ section, variant = 'web' }: TeamsGuideCardProps) {
  if (variant === 'mobile') {
    return (
