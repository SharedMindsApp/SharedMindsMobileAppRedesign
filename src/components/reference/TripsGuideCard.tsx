/**
 * Trips Guide Card Component
 * 
 * Phase 9: UI component for displaying a Trips guide section with visual connections.
 */

import { TripsGuideSection } from './tripsGuideContent';
import { ArrowRight } from 'lucide-react';

interface TripsGuideCardProps {
  section: TripsGuideSection;
  variant?: 'mobile' | 'web';
}

export function TripsGuideCard({ section, variant = 'web' }: TripsGuideCardProps) {
  if (variant === 'mobile') {
    return (
