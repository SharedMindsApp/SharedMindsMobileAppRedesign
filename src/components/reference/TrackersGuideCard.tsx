/**
 * Trackers Guide Card Component
 * 
 * Phase 9: UI component for displaying a Trackers guide section with visual connections.
 */

import { TrackersGuideSection } from './trackersGuideContent';
import { ArrowRight } from 'lucide-react';

interface TrackersGuideCardProps {
  section: TrackersGuideSection;
  variant?: 'mobile' | 'web';
}

export function TrackersGuideCard({ section, variant = 'web' }: TrackersGuideCardProps) {
  if (variant === 'mobile') {
    return (
