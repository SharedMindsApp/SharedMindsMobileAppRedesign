/**
 * Guardrails Features Index
 * 
 * Phase 9: Main page showing all Guardrails features as selectable cards.
 * Users can click any feature to read about it.
 */

import { GuardrailsGuideItem } from './guardrailsGuideContent';
import { getAllGuardrailsGuideItems } from './guardrailsGuideContent';

interface GuardrailsFeaturesIndexProps {
  features: GuardrailsGuideItem[];
  onSelectFeature: (featureId: string) => void;
  variant?: 'mobile' | 'web';
}

export function GuardrailsFeaturesIndex({
  features,
  onSelectFeature,
  variant = 'web',
}: GuardrailsFeaturesIndexProps) {
  if (variant === 'mobile') {
    return (
