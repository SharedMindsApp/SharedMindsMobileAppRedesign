/**
 * Calendar Guide Card Component
 * 
 * Phase 9: UI component for displaying a Calendar guide section with visual connections.
 */

import { CalendarGuideSection } from './calendarGuideContent';
import { ArrowRight } from 'lucide-react';

interface CalendarGuideCardProps {
  section: CalendarGuideSection;
  variant?: 'mobile' | 'web';
}

export function CalendarGuideCard({ section, variant = 'web' }: CalendarGuideCardProps) {
  if (variant === 'mobile') {
    return (
