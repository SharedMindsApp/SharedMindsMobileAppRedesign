/**
 * Planner Guide Card Component
 * 
 * Phase 9: UI component for displaying a Planner feature in the guide.
 */

import { PlannerGuideItem } from './plannerGuideContent';

interface PlannerGuideCardProps {
  feature: PlannerGuideItem;
  variant?: 'mobile' | 'web';
}

export function PlannerGuideCard({ feature, variant = 'web' }: PlannerGuideCardProps) {
  if (variant === 'mobile') {
    return (
