...
// Used by the profile location picker. Keep alphabetical by name.
...
export function findCountry(code: string | null | undefined): Country | null {
  if (!code) return null;
  return COUNTRY_INDEX.get(code.toUpperCase()) ?? null;
}

/** Build a display location string from structured fields. */
export function formatLocation(
  ...
  if (country && trimmedCity) return `${trimmedCity}, ${country.name}`;
